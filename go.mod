...
require (
	...
	github.com/zonradkuse/go-ldap-authenticator v0.0.0-20190811095753-c33ec74d2853
	github.com/zonradkuse/oauth-authenticator v0.0.0-20190807164843-35fd5cfcf003
